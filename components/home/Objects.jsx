...
function Objects() {
  ...
  return (
    <>
      ...
      <Item color="#9dbeb7" position={[0, 1, 0.005]}>
        <sphereGeometry />
      </Item>
      <Item color="#9dbeb7" position={[width / 6, -height * 1, 0]}>
        <dodecahedronGeometry />
      </Item>
      <Item color="#9dbeb7" position={[-width / 5, -height * 1.8, -2]}>
        <coneGeometry args={[1, 1, 6]} />
      </Item>
      <Item color="#9dbeb7" position={[width / 4, -height * 2, 0]}>
        <coneGeometry args={[1.5, 1, 2]} />
      </Item>
      <Item color="#9dbeb7" position={[-width / 12, -height * 2.25, 0.5]}>
        <coneGeometry args={[0.25, 1.25, 12]} />
      </Item>
    </>
  )
}
